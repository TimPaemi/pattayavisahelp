/**
 * Sprint 45 — hreflang de/ru on EN profession pillars.
 */
const fs = require('fs');
...
const PAIRS = [
  { en: '/professions/english-teacher/', de: '/de/professions/english-teacher/', ru: '/ru/professions/english-teacher/' },
  { en: '/professions/fitness-trainer/', de: '/de/professions/fitness-trainer/', ru: '/ru/professions/fitness-trainer/' },
  { en: '/professions/diving-instructor/', de: '/de/professions/diving-instructor/', ru: '/ru/professions/diving-instructor/' },
];
