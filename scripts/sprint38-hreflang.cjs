/**
 * Sprint 38 — hreflang de/ru on EN ED + Tourist TR pillars.
 */
const fs = require('fs');
...
const PAIRS = [
  { en: '/visas/education-ed/', de: '/de/visas/education-ed/', ru: '/ru/visas/education-ed/' },
  { en: '/visas/tourist-tr-evisa/', de: '/de/visas/tourist-tr-evisa/', ru: '/ru/visas/tourist-tr-evisa/' },
];
