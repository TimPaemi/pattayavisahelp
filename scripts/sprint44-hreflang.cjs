/**
 * Sprint 44 — hreflang de/ru on EN profession pillars.
 */
const fs = require('fs');
...
const PAIRS = [
  { en: '/professions/affiliate-marketer/', de: '/de/professions/affiliate-marketer/', ru: '/ru/professions/affiliate-marketer/' },
  { en: '/professions/crypto-trader/', de: '/de/professions/crypto-trader/', ru: '/ru/professions/crypto-trader/' },
  { en: '/professions/ai-engineer/', de: '/de/professions/ai-engineer/', ru: '/ru/professions/ai-engineer/' },
];
